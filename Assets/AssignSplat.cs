 ...
 * and modified for use with current project */
    ...
    void Start()
    {
        ...
        for (int y = 0; y < terrainData.alphamapHeight; y++)
        {
            for (int x = 0; x < terrainData.alphamapWidth; x++)
            {
                ...
                //splatWeights[1] = 1.3f * Mathf.Clamp01((terrainData.heightmapHeight - height));

                if (height < 4 || (height > 13 && height < 15))
                {
                    splatWeights[1] = height * 0.7f;
                }
                else
                {
                    splatWeights[1] = 0.3f;
